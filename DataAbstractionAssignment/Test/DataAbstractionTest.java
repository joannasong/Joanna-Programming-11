...
public class DataAbstractionTest {
    ...
    public void customerWithdrawTest(){
        ...
        assertEquals(testCustomer.getCheckBalance(), 100.0, 0.0);
        testCustomer.withdraw(70.0, testDate, "Saving");
        assertEquals(testCustomer.getCheckBalance(), -20.0, 0.0);
        assertEquals(testCustomer.getWithdraws().size(), 3);
        assertEquals(testCustomer.getWithdraws().get(2).getAmount(), 70.0, 0.0);
        ...
        testCustomer.setSavingBalance(0.0);
        testCustomer.withdraw(190.0, testDate, "Saving");
        assertEquals(testCustomer.getCheckBalance(), -100.0, 0.0);
